import 'package:arac_takip_app/Arac4zincirSayac.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class arac4z extends StatefulWidget {
  @override
...
class _arac4z extends State<arac4z> {
              ...
              new RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (BuildContext context) => (sayac4z(
